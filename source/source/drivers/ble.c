...
#if !BLE_MASTER
const u8 my_ble_devName[] = {DEV_NAME};
...
const u8 tbl_advData[] = { // https://www.bluetooth.com/specifications/assigned-numbers/generic-access-profile/
	 ...
	 0x01 + ((SPP_SERVICE_ENABLE)? 2 : 0) + ((SERVICE_UUID_BATTERY)? 2 : 0) , 0x02,
...
#define SPP_DATA_SERVER2CLIENT		0xfb,0x34,0x9b,0x5f,0x80,0x00, 0x00,0x80, 0x00,0x10, 0x00,0x00, (SERVICE_UUID_SPP&0xFF)+1,SERVICE_UUID_SPP>>8,0x00,0x00

const u8 SppServiceUUID[16]			= {SPP_UUID_SERVICE};
const u8 SppDataUUID[16] 			= {SPP_DATA_SERVER2CLIENT}; // "SPP: Module<->Phone"

//SPP data descriptor
const u8 SppS2cDescriptor[] = "SPP: Module<->Phone";
...
const attribute_t my_Attributes[] = {
	...
	{0,ATT_PERMISSIONS_READ,2,DEV_NAME_SIZE, (u8*)(&my_devNameUUID), (u8*)(&my_ble_devName), 0},
...
#if (SPP_SERVICE_ENABLE)
	////////////////////////////////////// SPP Service /////////////////////////////////////////////////////
	{5,ATT_PERMISSIONS_READ,2,16,(u8*)(&my_primaryServiceUUID), 	(u8*)(&SppServiceUUID), 0},
	{0,ATT_PERMISSIONS_READ, 2,sizeof(SppS2cCharVal),(u8*)(&my_characterUUID),	(u8*)(SppS2cCharVal), 0},
	{0,ATT_PERMISSIONS_RDWR,16,sizeof(SppDataBuffer),(u8*)(&SppDataUUID), (u8*)&SppDataBuffer, (att_readwrite_callback_t)&onSppReceiveData, (att_readwrite_callback_t)&onSppSendData},
...
u8  tbl_mac[6] = {0xe1, 0xe1, 0xe2, 0xe3, 0xe4, 0xc7};
