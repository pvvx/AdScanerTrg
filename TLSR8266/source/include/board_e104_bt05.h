 ...
 *-ANA_F1:  SPI_CK/I2C_SCL	// не выведен! возможно соединить с PF0
 * -----------------------------------------
 * *
...
//--------------------- DEBUG PRINTF
	...
	#define	DEBUG_INFO_TX_PIN	    	GPIO_PE6	//	print
